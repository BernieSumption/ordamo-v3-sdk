...
function makeInteractionsMessage(events) {
    return {
        eventType: "interactions",
        touchEvents: events.map(function (e) { return makeCrossWindowTouchEvent(e); })
    };
}
exports.makeInteractionsMessage = makeInteractionsMessage;
function makeCrossWindowTouchEvent(touchEvent) {
    ...
    return {
        ...
        touches: touches.map(function (t) { return makeCrossWindowTouch(t); }),
        changedTouches: changedTouches.map(function (t) { return makeCrossWindowTouch(t); }),
...
function makeCrossWindowTouch(touch) {
    return {
