...
function generateAllCommand(contentSourceFolder, buildFolder, assetsFolder) {
    ...
    var VIDEO_FORMATS = ["mp4", "ogv", "webm"];
            ...
            if (schemaItem.type === "list") {
                if (!Array.isArray(content[key])) {
                    ...
                    if (schemaItem.items.type === "image") {
                        ...
                        content[key].forEach(function (path, i) { return validateImage(path, "content." + key + "[" + i + "]", schemaItem.items.isVideo ? VIDEO_FORMATS : IMAGE_FORMATS); });
                    }
    ...
    function validateImage(imagePath, propName, formats) {
